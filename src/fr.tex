...
\section{Expérience Professionnelle}
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
            {Analyste Développeur}{Juin 2024 -- Août 2026}
            {IMATECH, Groupe IMA}{Nantes, France}
            \resumeItemListStart
                \resumeItem{Développement d'une solution \textbf{RAG} juridique avec agents IA (\textbf{LangChain}, \textbf{LangGraph}), backend \textbf{Node.js} et frontend \textbf{React}, alimentée par des fiches juridiques internes, utilisée par 150 juristes internes et commercialisée.}
                \resumeItem{Conception et implémentation d'une architecture microservices modulaire et configurable (\textbf{Python}, \textbf{Node.js}), pour la vectorisation incrémentale de documents (\textbf{RAG}), réduisant significativement les coûts d'inférence.}
...
\section{Formation}
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
            ...
            {Maîtrise en Informatique : IA (apprentissage profond), structures de données avancées}
            {Août 2022 -- Jan. 2024}
        \vspace{2pt}
